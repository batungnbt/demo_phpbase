...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO employees(name,gender,birthday,address,salary) VALUES(:name,:gender,:birthday,:address,:salary)";

        if($stmt = $conn->prepare($sql)) {
            if ($stmt->execute($employee)) {
                $_SESSION['message'] = 'Successfully added,<a href="index.php">See the list here</a>';
        ...
        <div class="col-12">
            ...
            <form action="create.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="birthday" placeholder="Enter full name employee.">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Address</label>
                    <input type="text" class="form-control" name="address" placeholder="Enter address employee.">
                </div>
                <div class="form-group">
